        ...
        <>
            <section className="bg-base-200 overflow-hidden" id="pricing">
                <div className="py-12 px-5 max-w-5xl mx-auto">
                    ...
                    <div className='text-xl flex flex-wrap justify-start items-start flex-col gap-8'>
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="item-1">
                                <AccordionTrigger className="text-start">What areas in Sydney do you service?</AccordionTrigger>
                                <AccordionContent className="text-lg text-start">
                            ...
                            <AccordionItem value="item-2">
                                <AccordionTrigger className="text-start">What cleaning products do you use?</AccordionTrigger>
                                <AccordionContent className="text-lg text-start">
                            ...
                            <AccordionItem value="item-3">
                                <AccordionTrigger className="text-start">How do I book a cleaning service?</AccordionTrigger>
                                <AccordionContent className="text-lg text-start">
                                    You can book a cleaning service online through our website or by calling our customer service team directly.
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="item-4">
                                <AccordionTrigger className="text-start">What if I need to cancel or reschedule my appointment?</AccordionTrigger>
                                <AccordionContent className="text-lg text-start">
                            ...
                            <AccordionItem value="item-5">
                                <AccordionTrigger className="text-start">Are your cleaners insured?</AccordionTrigger>
                                <AccordionContent className="text-lg text-start">
